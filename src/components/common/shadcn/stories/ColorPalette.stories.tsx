...
const colorGroups = {
  ...
  backgrounds: [
    ...
    { name: "Error Page Bg", cssVar: "errorPageBg" },
    { name: "Destructive Alert Bg", cssVar: "destructiveAlertBg" },
    { name: "Success Alert Bg", cssVar: "successAlertBg" },
    { name: "Info Alert Bg", cssVar: "infoAlertBg" },
    { name: "Side Menu Button Bg", cssVar: "sideMenuButtonBg" },
    { name: "Side Menu Button Bg Hover", cssVar: "sideMenuButtonBgHover" },
    { name: "Auth Theme Button Bg", cssVar: "authThemeButtonBg" },
    { name: "Auth Theme Button Bg Hover", cssVar: "authThemeButtonBgHover" },
    { name: "Auth Page Logo Circle Bg", cssVar: "authPageLogoCircleBg" },
    {
      name: "Settings Drawer Github Bg",
      cssVar: "settingsDrawerGithubBg",
    },
    {
      name: "Settings Drawer Github Bg Hover",
      cssVar: "settingsDrawerGithubBgHover",
    },
  ],
  borders: [
    ...
    {
      name: "Checkbox Unchecked Border Hover",
      cssVar: "checkboxUncheckedBorderHover",
    },
    ...
    { name: "Auth Theme Button Border", cssVar: "authThemeButtonBorder" },
    {
      name: "Auth Theme Button Border Hover",
      cssVar: "authThemeButtonBorderHover",
    },
  ],
};
